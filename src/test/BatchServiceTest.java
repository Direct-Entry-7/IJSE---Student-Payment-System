...
public class BatchServiceTest {
    ...
    private static void saveBatch() throws DuplicateEntryException, NotFoundException {
        ...
        Batch batch1 = new Batch("DEP", "10", LocalDate.of(2021, 01, 05), LocalDate.of(2021, 05, 15), "Batch 10", BigDecimal.valueOf(100000),null);
    ...
    private static void updateBatch() throws NotFoundException {
        BatchService batchService = new BatchService();
        Batch batch1 = new Batch("Dep7", "3", LocalDate.of(2021, 01, 05), LocalDate.of(2021, 05, 15), "Batch 10",BigDecimal.valueOf(125000),null);
