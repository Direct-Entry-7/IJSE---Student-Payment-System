...
public class UserService {
    ...
    static {
        ...
        User user2 = new User("Normal User", "Normal User 1", "normaluser1@gmail.com", "0777948311", "password2");
        User user3 = new User("Admin", "Admin 2", "admin2@gmail.com", "0772948370", "password3");
        User user4 = new User("Normal User", "Normal User 2", "normaluser2@gmail.com", "0782948323", "password4");
